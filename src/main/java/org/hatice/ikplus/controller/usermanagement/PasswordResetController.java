...
public class PasswordResetController {
	...
	public ResponseEntity<BaseResponse<String>> requestPasswordReset(@RequestParam String email) {
		...
		return ResponseEntity.ok(BaseResponse.<String>builder()
		                                     .success(true)
		                                     .message("Şifre yenileme işlemi mail adresinize gönderildi")
		                                     .code(200)
		                                     .data(null)
		                                     .build());
	}
	...
	public ResponseEntity<BaseResponse<String>> resetPassword(@RequestParam String token, @RequestParam String newPassword) {
